...
class SalesView(LoginRequiredMixin,TemplateView):
    ...
    def get_context_data(self,*args,**kwargs):
        ...
        # context['orders'] = qs
        # context['recent_orders'] = qs.recent()
        # #Get total of recent orders
        # recent_orders_total = 0
        # for i in context['recent_orders']:
        #     recent_orders_total += i.total
        # print(recent_orders_total)
        # context['shipped_orders'] = qs.recent().by_status(status='shipped')
        # context['paid_orders'] = qs.recent().by_status(status='paid')
